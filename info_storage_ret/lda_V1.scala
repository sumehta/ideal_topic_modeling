...
//val file: FileOps = Path("hdfs://nameservice1/user/cs5604s16_to/shooting_small_topic_words")
//file.write(finalTopicWords map(_.toByte))
...
//var rev = result.join(idkey)
//conv.saveAsTextFile("hdfs://nameservice1/user/cs5604s16_to/doc_topic_converted")
var topiclist = ""
var x = 1
